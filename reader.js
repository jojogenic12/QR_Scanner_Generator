...
var Html5QrcodeScanner = function() {
    ...
    return _createClass(a, [{
        ...
        value: function() {
           ...
           g.style.display = "inline-block"; g.style.marginTop = "40px"; g.style.textDecoration = "none", g.id = this.__getDashboardSectionSwapLinkId(), g.innerHTML = this.currentScanType == a.SCAN_TYPE_CAMERA ? c : d, g.href = "#scan-using-file", g.addEventListener("click", function() {
